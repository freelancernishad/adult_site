...
<script type="text/javascript">
	...
	document.getElementsByClassName("submenu")[0].classList.add("menu-open");
...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <span class='btn btn-info' onclick='addNew("form/add_country.php")' >Add New</span>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">country_list</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="dataTable" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td align="center"><a href="#"  onclick='addNew("form/add_country.php")'  data-toggle="tooltip" title="" data-original-title="Edit"><i style="color: blue" class="far fa-edit"></i></a>&nbsp;
